                        ...
                        @if($lawyerProfile)
                            <form method="post" enctype="multipart/form-data" action="{{route('lawyerProfile')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="firstName" value="{{$lawyerProfile->firstName}}" type="text"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="middleName" value="{{$lawyerProfile->middleName}}" type="text"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="lastName" value="{{$lawyerProfile->lastName}}" type="text"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input id="inputEmail" name="email" value="{{$lawyerProfile->email}}" type="email"
                                ...
                                <div class="form-group">
                                    <label for="inputPassword">Contact Number <code
                                            style="color: blue">(Optional)</code> :</label>
                                    <input id="inputPassword" type="number" value="{{$lawyerProfile->contactNumber}}"
                                           name="contactNumber" max="1000000000"
                                           class="form-control">
                                </div>
                                <div class="form-group">
